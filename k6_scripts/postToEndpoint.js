...
export default function() {
  let activator_url = __ENV.ACTIVATOR_URL || "http://localhost:5000";
  let service_endpoint = __ENV.SERVICE_ENDPOINT || "/endpoints";
  var payload = JSON.stringify({
    artifact: [ 'src/welcome.py' ],
    engine: 'python',
    entry: 'src/welcome.py',
    function: 'welcome',
    baseUrl: 'http://localhost:8080/proxy/artifacts/python/simple/v1.0/',
    uri: 'python/simple/1.0/welcome'
  });
